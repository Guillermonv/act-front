  ...
  return (
    React.createElement("div", {
      ...
      React.createElement("div", { style: { maxWidth: "1200px", width: "100%" } },
        ...
        // 🔘 Encabezado con Toggle, Título y Botón "Add Task"
        React.createElement("div", {
          style: {
            display: "flex",
        ...
        showBoard && React.createElement(React.Fragment, null,
          loading
            ? React.createElement("div", { style: { textAlign: "center", padding: "50px", color: "#555" } }, "Cargando tareas...")
            : error
              ? React.createElement("div", { style: { textAlign: "center", padding: "50px", color: "red" } }, "Error: ", error)
